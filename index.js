...
// comando para eliminar la inscripción de un estudiante en un curso
	...
	break
//comando para actualizar los datos del usuario
	case 'actualizardatos':
	funciones.actualizardatos(argv.nombre, argv.id, argv.correo, argv.telefono);
	break
// comando para actualizar el tipo de usuario
	case 'actualizartipo':
	funciones.actualizartipo(argv.id, argv.tipo);
	break
